...
\textbf{Energy breakdown validates data-movement-dominated design.}
DRAM (61.8\%), weight SPAD (18.4\%), and NoC collectively account for $>$85\% of total energy while MACs consume only 3.8\%, confirming a 16:1 data-movement-to-computation ratio~\cite{sze2017efficient}.
The 60\% PE utilization at 168 PEs reveals that smaller layers underutilize the array, motivating per-layer mapping optimization---a capability unique to analytical accelerator models.
