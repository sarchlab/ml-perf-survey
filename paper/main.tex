...
A cross-cutting limitation is \emph{scope rigidity}: analytical tools cannot capture dynamic sparsity, cycle-accurate simulators are too costly for design-space sweeps, and trace-driven tools assume deterministic replay that breaks under stochastic serving policies.
